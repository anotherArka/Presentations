...
\author{Arka Ghosh}
\institute{Guided by - Prof. Siddhartha Gadgil }
\date{}
...
\item This fibration satisfies \emph{path lifting property} automatically.
}\visible<3->{ 
...
\item Univalence axiom due to Voevodsky says that this itself is an equivalence. That is,
